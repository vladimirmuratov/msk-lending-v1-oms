...
export const MainInfoBlock = () => {
    return (
        ...
        >
            ...
            <Typography component="p" sx={{fontSize: 20, marginBottom: '20px'}}>
                Заботьтесь о своем здоровье без задержек! Мы предлагаем платную госпитализацию без полиса
                ОМС. Быстрая и качественная медицинская помощь доступна именно тогда, когда она вам нужна. Забудьте о
                долгих очередях и непредсказуемых сроках – мы гарантируем комфортное лечение и внимание лучших
                специалистов. Ваше здоровье – наша главная забота.
                <br/>
                <br/>
